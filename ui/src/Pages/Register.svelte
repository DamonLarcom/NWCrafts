<script>
    ...
    let username, password, email,server,alignment;
    let crafter = false;
...
<div id="wrapper">
    <form id="register_form">
        ...
        <button type="submit" on:click|preventDefault={onClick}>Register</button>
        <p>Misclick? <a href="/login">Go back to login</a></p>
    </form>
</div>
